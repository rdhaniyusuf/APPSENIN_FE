...
import { subItems } from "@/utils/Helpers";
import {
  Card,
  CardBody,
  CardFooter,
...
const NavSetComp: FC<TabsProps> = () => {
  ...
  return (
    <div className="flex mt-5 flex-col px-4 max-h-max gap-3">
      <Tabs
        aria-label="Tabs"
        className="hover:bg-clip-text-red-300 gap-3"
        placement={"start"}
        variant="light"
      >
...
const SetProfileComp = () => {
  return (
    <div className="justify-center p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
...
export { GeneralSetComp, NavSetComp, SetProfileComp };
